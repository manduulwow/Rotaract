...
const Slider = (props) => {
    ...
    let slideCount = slideCount = parseInt((data.length / 12) + ((data.length % 12 > 0) ? 1 : 0))
    ...
    return (
        <div id="slider-window">
            ...
            <div id="slide-title-section">
                <span style={{ marginLeft: "46px" }}>Members</span>
                <div id="slide-title-line"></div>
                <div id="search-wrapper">
                    <div id="searchIcon">
                        <img src={require('../../img/searchIcon.png')}></img>
                    </div>
